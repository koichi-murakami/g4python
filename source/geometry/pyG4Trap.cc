...
// --------------------------------------------------------------------------
G4Trap* f4_CreateTrap(const G4String& name,
...
// --------------------------------------------------------------------------
G4Trap* f6_CreateTrap(const G4String& name,
...
void export_G4Trap(py::module& m)
{
  ...
  .def(py::init<const G4String&, G4double, G4double, G4double,
	 ...
	 // ---
	 m.def("CreateTrap", &::f1_CreateTrap, py::return_value_policy::reference);
	 m.def("CreateTrap", &::f2_CreateTrap, py::return_value_policy::reference);
	 m.def("CreateTrap", &::f3_CreateTrap, py::return_value_policy::reference);
	 m.def("CreateTrap", &::f4_CreateTrap, py::return_value_policy::reference);
	 m.def("CreateTrap", &::f5_CreateTrap, py::return_value_policy::reference);
	 m.def("CreateTrap", &::f6_CreateTrap, py::return_value_policy::reference);
}
